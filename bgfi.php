...
if(isset($_GET['tag'])) {
    ...
    define('USERNAME',     'azurhotspot');
    define('SECRET',     'f2f7226b-df1d-11e6-bf15-3863bb43c614');
    ...
    */
    ...
    $url1 = "https://api.bgfi.com/authentication/sign";
    $url2 = "https://api.bgfi.com/payment/prepare";
    $url3 = "https://api.bgfi.com/payment/conclude";
    ...
    */
    ...
    if ($tag == 'init'){
        ...
        if(isset($result)) {
            ...
            if (isset($parse_result1['token'])) {
                $token = $parse_result1['token'] ;
                $array2 = array(
                ...
                $result2 = sendData2($url2, $array2, $token);





                if(isset($result2['reference'])) {
